...
SimpleSanitize is a Ruby on Rails plugin that automatically strip tags from input fields.
...
1. Does not strip a parameter:

  sanitize_fields :except => [:title]

2. Uses 'sanitize' instead of 'strip_tags':
